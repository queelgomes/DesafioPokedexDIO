// function pegarPokemon(numeroPokemon = 1){
//     pokemonEscolhido = numeroPokemon;
// }
            ...
            <section id="popup-pokemon" class="${pokemonEscolhido[0].typeMain}">
                <header>
                    <div class="pokemonData">
                        <div>
                            ...
                            <ol>
                            ${pokemonEscolhido[0].type
                                .map(
                                    (type) =>
                                        `<li class="tipoPokemon">${type}</li>`
                                )
                                .join("")}
                            </ol>
                        </div>
                ...
                <article class="pokemonDetails">
                    ...
                    <section class="conteudo">
                        ...
                        <footer class="copy">Desenvolvido por &copy Quel Gomes</footer>
                        </section>
                    </section>
            ...
            <section class="about">
                    <div class="pokemonInfos">
                        ...
                        <ol class="infoDescription">
                            <li>${pokemonEscolhido[0].typeMain}</li>
                            <li>${pokemonEscolhido[0].height} cm</li>
                            <li>${pokemonEscolhido[0].weight} gr</li>
